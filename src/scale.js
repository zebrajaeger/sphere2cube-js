...
class Bilinear extends EventEmitter {
    scale(srcParams, targetParams, getPixel, setPixel) {
        ...
        // console.log('bilinear', {srcParams, targetParams}, {wSrc, hSrc, wDst, hDst})
        const assign = function (dX, dY,
                                 x, xMin, xMax,
                                 y, yMin, yMax,
                                 getPixel, setPixel) {
            // console.log({dX, dY,x, xMin, xMax,y, yMin, yMax})
...
//
// module.exports.bilinear = (srcParams, targetParams, getPixel, setPixel) => {
//     const wSrc = srcParams.w;
//     const hSrc = srcParams.h;
//
//     const wDst = targetParams.w;
